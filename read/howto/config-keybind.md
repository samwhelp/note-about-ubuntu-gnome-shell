...
org.gnome.shell.extensions.tiling-assistant dynamic-keybinding-behavior 0
org.gnome.shell.extensions.tiling-assistant overridden-settings {'org.gnome.mutter.edge-tiling': <@mb nothing>, 'org.gnome.desktop.wm.keybindings.maximize': <@mb nothing>, 'org.gnome.desktop.wm.keybindings.unmaximize': <@mb nothing>, 'org.gnome.mutter.keybindings.toggle-tiled-left': <@mb nothing>, 'org.gnome.mutter.keybindings.toggle-tiled-right': <@mb nothing>}
...
> 執行下面指令，探索關於「`org.gnome.shell.keybindings`」的設定。
